        ...
        >
            ...
            >
                ...
                <template #header="{columns, records, sortPage, applied}">
                    <div style="grid-template-columns: repeat(7,minmax(0,1fr))" class="row grid grid-cols-{{ $hasPermission ? '6' : '5' }} gap-2.5 items-center px-4 py-2.5 border-b dark:border-gray-800 text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 font-semibold">
                        <div
                            class="flex gap-2.5 cursor-pointer"
                            v-for="(columnGroup, index) in ['user_id', 'user_name', 'status', 'email', 'role_name', 'outlet_name']"
                        >
                    ...
                    <x-admin::modal ref="userUpdateOrCreateModal">
                        ...
                        <x-slot:content>
                            ...
                            <div class="flex gap-4">
                                ...
                                <!-- Outlet -->
                                <x-admin::form.control-group class="flex-1 w-full" v-if="data.user?.role_id === roles.find(role => role.name === 'Outlet Manager')?.id">
                                    <x-admin::form.control-group.label class="required">
                                        Outlet
                                    </x-admin::form.control-group.label>
