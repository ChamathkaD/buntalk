                                    ...
                                    <div class="flex gap-2.5">
                                        ...
                                        <div class="grid gap-1.5 place-content-start">
                                            ...
                                            <div class="flex flex-col gap-1.5 place-items-start">
                                                ...
                                                @isset($item->additional['order_note'])
                                                    <p class="text-green-600 dark:text-green-300 italic">
                                                        {{ $item?->additional['order_note'] }}
                                                    </p>
                                                @endisset
                                            </div>
                                        </div>
                                ...
                                <div class="flex w-full gap-5 justify-start">
                                    ...
                                    <div class="flex flex-col gap-y-1.5">
                                        ...
                                        <p class="text-red-600">
                                            {{core()->formatDate($order->delivery_date)}}
                                        </p>
