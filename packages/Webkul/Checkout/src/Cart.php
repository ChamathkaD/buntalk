...
class Cart
{
     ...
     */
    public function saveShippingMethod($shippingMethodCode, $outlet): bool
    {
        $cart = $this->getCart();
    ...
    /**
     * Save Delivery Time Slot for cart.
     *
     * @param  $datetime
     */
    public function saveDeliveryTimeSlot($date, $timeslot, $notes = null): bool
    {
        $cart = $this->getCart();
        ...
        $cart->delivery_date = $date;
        $cart->timeslot = $timeslot;
        $cart->additional_notes = $notes;
        $cart->save();
