                    ...
                    <x-slot:header class="!py-4 !px-0">
                        ...
                        <x-slot:content class="!p-0 mt-8">
                            ...
                            <div class="flex flex-wrap gap-8">
                                <div
                                    class="relative max-sm:flex-auto select-none"
                                ...
                                >
                                    ...
                                    <div v-for="rate in shippingMethod.rates">
                                        ...
                                        >
                                            ...
                                            <div class="mt-2 max-w-[218px]"
                                                 v-if="rate.method_title === 'Pickup from Outlet'">
            ...
            methods: {
                store(selectedShippingMethod) {
                    ...
                    this.$axios.post("{{ route('shop.checkout.onepage.shipping_methods.store') }}", {
                        ...
                        outlet: selectedShippingMethod === 'outletpickup_outletpickup' ? document.getElementById('outlet').value : '-',
                    })
                        .then(response => {
